...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO formacion (id_empl, propietario, instituto, nivel, especializacion, area, estado, duracion, fecha_de_inicio, fecha_de_incorporacion) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['fecha_de_inicio'], "date"),
                       GetSQLValueString($_POST['fecha_de_incorporacion'], "date"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());

  $insertGoTo = "ListadoFormacion.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<?php include("includes/cabecera.php"); ?>
 ...
 <h5><strong>INGRESAR FORMULARIO</strong><h5>
...
<br />
  ...
  <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Propietario:</td>
        <td><input class="form-control" type="text" name="propietario" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Instituto:</td>
        <td><input class="form-control" type="text" name="instituto" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Nivel:</td>
        <td><input class="form-control" type="text" name="nivel" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Especializacion:</td>
        <td><input class="form-control" type="text" name="especializacion" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Area:</td>
        <td><input class="form-control" type="text" name="area" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Estado:</td>
        <td><input class="form-control" type="text" name="estado" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Duracion:</td>
        <td><input class="form-control" type="text" name="duracion" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Fecha de Inicio:</td>
        <td><input class="form-control" type="text" name="fecha_de_inicio" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="left">Fecha de Incorporacion:</td>
        <td><input class="form-control" type="text" name="fecha_de_incorporacion" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
