...
$query_Recordset1 = "SELECT datos_carga.id_datcarga, datos_carga.id_carga, datos_carga.cedulac, datos_carga.sexo, datos_carga.nombresc, datos_carga.apellidosc, datos_carga.fecha_de_nacimieto, datos_carga.edad, datos_carga.tipo_de_sangre, datos_carga.tipo_de_relacion, datos_carga.estado_civil, datos_carga.ocupacion, datos_carga.discapasidad, datos_carga.telefono, datos_carga.celular, datos_carga.correo, carga_familiar.id_empl, carga_familiar.numero_de_cargas, empleado.cedula, empleado.nombres, empleado.apellidos FROM datos_carga, carga_familiar, empleado WHERE datos_carga.id_carga = carga_familiar.id_carga AND carga_familiar.id_empl = empleado.id_empl";
...
<?php include("includes/cabecera.php"); ?>
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
    ...
    <table class="table"  table-striped table-bordered border="0" table-hover>
      <tr class="success">
        ...
        <td>Sexo</td>
        <td>Nombres Carga</td>
        <td>Apellidos Carga</td>
        <td>Fecha de Nacimieto</td>
        <td>Edad</td>
      ...
      <?php do { ?>
        <tr>
        <!--  <td><?php echo $row_Recordset1['id_datcarga']; ?></td>
         ...
         <!-- <td><?php echo $row_Recordset1['cedula']; ?></td -->>
          ...
          <td><?php echo $row_Recordset1['cedulac']; ?></td>
          <td><?php echo $row_Recordset1['sexo']; ?></td>
          <td><?php echo $row_Recordset1['nombresc']; ?></td>
          <td><?php echo $row_Recordset1['apellidosc']; ?></td>
          <td><?php echo $row_Recordset1['fecha_de_nacimieto']; ?></td>
          <td><?php echo $row_Recordset1['edad']; ?></td>
          <td><?php echo $row_Recordset1['tipo_de_sangre']; ?></td>
          <td><?php echo $row_Recordset1['tipo_de_relacion']; ?></td>
          <td><?php echo $row_Recordset1['estado_civil']; ?></td>
          <td><?php echo $row_Recordset1['ocupacion']; ?></td>
          <td><?php echo $row_Recordset1['discapasidad']; ?></td>
  ...
  <tr>
    <td width="67"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, max(0, $pageNum_Recordset1 - 1), $queryString_Recordset1); ?>">Atras</a></td>
