...
<?php include("includes/cabecera.php"); ?>
  ...
  <h5><strong>INGRESAR EMPLEADO</strong><h5>
   
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
        
        <tr  valign="baseline">
          <td style="vertical-align:middle;"  nowrap="nowrap" align="right"><label for="cedula">Cedula:&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
          <td><input class="form-control" type="text" name="cedula" value="" size="32" /></td>
        </tr>
      
        <tr valign="baseline">
          <td style="vertical-align:middle;" nowrap="nowrap" align="right"><label for="nombre">Nombres:&nbsp;&nbsp;</label></td>
          <td style="vertical-align:top;"><input class="form-control" type="text" name="nombres" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td style="vertical-align:middle;" nowrap="nowrap" align="right"><label for="cedula">Apellidos:&nbsp;</label></td>
          <td><input class="form-control" type="text" name="apellidos" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td style="vertical-align:middle;" nowrap="nowrap" align="right">&nbsp;</td>
