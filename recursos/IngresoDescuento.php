...
<?php include("includes/cabecera.php"); ?>
  ...
  <h5><strong>INGRESAR DESCUENTO</strong><h5>
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Tipo de Descuento:</td>
      <td><input class="form-control" type="text" name="tipo_descuento" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="left">Valorde Descuento:</td>
      <td><input class="form-control" type="text" name="valor_descuento" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
