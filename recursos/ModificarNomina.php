...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE nomina SET sueldo_nominal=%s, total_horas_extra=%s, beneficio_horas_extra=%s, comisiones=%s, fecha_ingreso=%s WHERE id_nom=%s",
...
<?php include("includes/cabecera.php"); ?>
  ...
  <h5><strong>MODIFICAR NOMINA</strong><h5>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Sueldo_nominal:</td>
          <td><input class="form-control" type="text" name="sueldo_nominal" value="<?php echo htmlentities($row_Recordset1['sueldo_nominal'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Total_horas_extra:</td>
          <td><input class="form-control" type="text" name="total_horas_extra" value="<?php echo htmlentities($row_Recordset1['total_horas_extra'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Beneficio_horas_extra:</td>
          <td><input class="form-control" type="text" name="beneficio_horas_extra" value="<?php echo htmlentities($row_Recordset1['beneficio_horas_extra'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Comisiones:</td>
          <td><input class="form-control" type="text" name="comisiones" value="<?php echo htmlentities($row_Recordset1['comisiones'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" /></td>
        </tr>
        
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Fecha de Ingreso:</td>
      ...
      <input type="hidden" name="id_nom" value="<?php echo $row_Recordset1['id_nom']; ?>" />
    </form>
    <p>&nbsp;</p>
  <!-- InstanceEndEditable -->
    <!-- end .sidebar1 --></div>
