...
$query_Recordset1 = "SELECT formacion.id_form, formacion.id_empl, formacion.propietario, formacion.instituto, formacion.nivel, formacion.especializacion, formacion.area, formacion.estado, formacion.duracion, formacion.fecha_de_inicio, formacion.fecha_de_incorporacion, empleado.cedula, empleado.nombres, empleado.apellidos FROM formacion, empleado WHERE formacion.id_empl = empleado.id_empl";
...
<?php include("includes/cabecera.php"); ?>
  ...
  <h5><strong>FORMACION DE EMPLEADOS</strong><h5>
    ...
    <table class="table"  table-striped table-bordered border="0" table-hover>
      ...
      <?php do { ?>
        ...
        <!--  <td><?php echo $row_Recordset1['id_form']; ?></td>
          ...
          <td><?php echo $row_Recordset1['propietario']; ?></td>
          <td><?php echo $row_Recordset1['instituto']; ?></td>
          <td><?php echo $row_Recordset1['nivel']; ?></td>
          <td><?php echo $row_Recordset1['especializacion']; ?></td>
          <td><?php echo $row_Recordset1['area']; ?></td>
          <td><?php echo $row_Recordset1['estado']; ?></td>
          <td><?php echo $row_Recordset1['duracion']; ?></td>
          <td><?php echo $row_Recordset1['fecha_de_inicio']; ?></td>
          <td><?php echo $row_Recordset1['fecha_de_incorporacion']; ?></td>
        </tr>
    ...
    <table width="378" border="0">
      <tr>
        <td width="31"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, max(0, $pageNum_Recordset1 - 1), $queryString_Recordset1); ?>">Atras</a></td>
...
Registros <?php echo ($startRow_Recordset1 + 1) ?> - <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> de <?php echo $totalRows_Recordset1 ?></td>
        <td width="73"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, min($totalPages_Recordset1, $pageNum_Recordset1 + 1), $queryString_Recordset1); ?>">Siguiente</a></td>
      </tr>
    </table>
	</div>
    </div>
