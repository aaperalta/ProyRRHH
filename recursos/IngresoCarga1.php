...
<?php include("includes/cabecera.php"); ?>
  ...
  <h5><strong>INGRESAR CARGAS</strong><h5>
    ...
    <table class="table"  table-striped table-bordered border="0" table-hover>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><a class="btn btn-success" href="IngresoCarga.php?id_empl=<?php echo $row_Recordset1['id_empl']; ?>">Ingresar Carga Familiar</a></td>
