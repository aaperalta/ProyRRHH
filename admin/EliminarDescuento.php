...
if ((isset($_GET['id_descu'])) && ($_GET['id_descu'] != "")) {
  $deleteSQL = sprintf("DELETE FROM descuento WHERE id_descu=%s",
                       GetSQLValueString($_GET['id_descu'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($deleteSQL, $conexion) or die(mysql_error());

  $deleteGoTo = "ListadoDescuento.php";
