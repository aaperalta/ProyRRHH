...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO carga_familiar (id_empl, numero_de_cargas, tipo_causante_de_carga, beneficio_de_carga) VALUES (%s, %s, %s, %s)",
    ...
    <tr valign="baseline">
      ...
      <td><input class="form-control" type="text" name="id_empl" value="<?php echo $row_Recordset1['id_empl']; ?>" size="32" /></td>
        ...
        <tr valign="baseline">
          ...
          <td><input class="form-control" type="text" name="numero_de_cargas" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Tipo Causante de Carga:</td>
          <td><input class="form-control" type="text" name="tipo_causante_de_carga" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Beneficio de Carga:</td>
          <td><input class="form-control" type="text" name="beneficio_de_carga" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
