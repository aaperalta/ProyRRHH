...
$query_Recordset1 = "SELECT departamento.id_dep, departamento.id_empl, departamento.nombre_departamento, departamento.ubicacion, departamento.directiva, departamento.funcion, departamento.numero_de_empleados, empleado.cedula, empleado.nombres, empleado.apellidos FROM departamento, empleado WHERE departamento.id_empl = empleado.id_empl";
...
<?php include("includes/cabecera.php"); ?>
  ...
  <h5><strong>LISTA DE DEPARTAMENTOS</strong><h5>
    ...
    <table class="table"  table-striped table-bordered border="0" table-hover>
      <tr class="success">
        ...
        <td>directiva</td>
        <td>funcion</td>
        <td>numero_de_empleados</td>
        
      </tr>
      <?php do { ?>
        <tr>
         <!-- <td><?php echo $row_Recordset1['id_dep']; ?></td>
          ...
          <td><?php echo $row_Recordset1['nombre_departamento']; ?></td>
          <td><?php echo $row_Recordset1['ubicacion']; ?></td>
          <td><?php echo $row_Recordset1['directiva']; ?></td>
          <td><?php echo $row_Recordset1['funcion']; ?></td>
          <td><?php echo $row_Recordset1['numero_de_empleados']; ?></td>
  ...
  <tr>
    <td width="51"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, max(0, $pageNum_Recordset1 - 1), $queryString_Recordset1); ?>">Atras</a></td>
