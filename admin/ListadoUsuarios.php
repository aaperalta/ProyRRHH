...
$query_Recordset1 = "SELECT users.idUsers, users.id_empl, users.loginUsers, users.passUsers, users.idprofile, users.emailUser, profiles.nameProfi, empleado.nombres, empleado.apellidos FROM users, profiles, empleado WHERE users.idprofile = profiles.idProfile AND users.id_empl = empleado.id_empl";
...
<?php include("includes/cabecera.php"); ?>
      ...
      <?php do { ?>
        <tr>
         <!-- <td><?php echo $row_Recordset1['idUsers']; ?></td>
          ...
          <td><?php echo $row_Recordset1['loginUsers']; ?></td>
         <!-- <td><?php echo $row_Recordset1['passUsers']; ?></td> -->
          <!--<td><?php echo $row_Recordset1['idprofile']; ?></td> -->
          <td><?php echo $row_Recordset1['nameProfi']; ?></td>
          <td><?php echo $row_Recordset1['emailUser']; ?></td>
          <td><?php echo $row_Recordset1['nombres']; ?></td>
          <td><?php echo $row_Recordset1['apellidos']; ?></td>      
          <td><a class="btn btn-success" href="ModificarUsuarios.php?idUsers=<?php echo $row_Recordset1['idUsers']; ?>">Modificar</a></td>
          <td><a class="btn btn-success" href="EliminarUsuario.php?idUsers=<?php echo $row_Recordset1['idUsers']; ?>">Eliminar</a></td>
        </tr>
  ...
  <tr>
    <td width="63"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, max(0, $pageNum_Recordset1 - 1), $queryString_Recordset1); ?>">Atras</a></td>
...
Registros <?php echo ($startRow_Recordset1 + 1) ?>  - <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> de <?php echo $totalRows_Recordset1 ?></td>
    <td width="68"><a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, min($totalPages_Recordset1, $pageNum_Recordset1 + 1), $queryString_Recordset1); ?>">Siguiente</a></td>
  </tr>
</table>
</div>
    </div>
