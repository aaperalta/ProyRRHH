...
if ((isset($_GET['id_empl'])) && ($_GET['id_empl'] != "")) {
  $deleteSQL = sprintf("DELETE FROM empleado WHERE id_empl=%s",
                       GetSQLValueString($_GET['id_empl'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($deleteSQL, $conexion) or die(mysql_error());

  $deleteGoTo = "ListadoEmpleados.php";
