...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO gastos_personales (id_empl, vestimenta, alimento, vivienda, salud, educacion, ejercicio_formal) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['id_empl'], "int"),
                       GetSQLValueString($_POST['vestimenta'], "double"),
                       GetSQLValueString($_POST['alimento'], "double"),
                       GetSQLValueString($_POST['vivienda'], "double"),
                       GetSQLValueString($_POST['salud'], "double"),
                       GetSQLValueString($_POST['educacion'], "double"),
                       GetSQLValueString($_POST['ejercicio_formal'], "double"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($insertSQL, $conexion) or die(mysql_error());

  $insertGoTo = "ListadoForm-gp.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input class="form-control" type="text" name="id_empl" value="<?php echo $row_Recordset1['id_empl']; ?>" size="32" /></td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Vestimenta:</td>
          <td><input class="form-control" type="text" name="vestimenta" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Alimento:</td>
          <td><input class="form-control" type="text" name="alimento" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Vivienda:</td>
          <td><input class="form-control" type="text" name="vivienda" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Salud:</td>
          <td><input class="form-control" type="text" name="salud" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Educacion:</td>
          <td><input class="form-control" type="text" name="educacion" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Ejercicio Formal:</td>
          <td><input class="form-control" type="text" name="ejercicio_formal" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
