...
if ((isset($_GET['id_carga'])) && ($_GET['id_carga'] != "")) {
  $deleteSQL = sprintf("DELETE FROM carga_familiar WHERE id_carga=%s",
                       GetSQLValueString($_GET['id_carga'], "int"));

  mysql_select_db($database_conexion, $conexion);
  $Result1 = mysql_query($deleteSQL, $conexion) or die(mysql_error());

  $deleteGoTo = "ListadoCarga.php";
