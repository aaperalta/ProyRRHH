  ...
  <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input class="form-control" type="text" name="id_empl" value="<?php echo $row_Recordset1['id_empl']; ?>" size="32" /></td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Empresa:</td>
          <td><input class="form-control" type="text" name="empresa" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Sub Area:</td>
          <td><input class="form-control" type="text" name="sub_area" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Persona a Cargo:</td>
          <td><input class="form-control"  type="text" name="pera_cargo" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Seniorly:</td>
          <td><input class="form-control"  type="text" name="seniorly" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Cargo Desempe&ntildeado:</td>
          <td><input class="form-control"  type="text" name="c_desem" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="left">Tiempo:</td>
          <td><input class="form-control"  type="text" name="tiempo" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
