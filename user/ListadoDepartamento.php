...
$query_Recordset1 = "SELECT departamento.nombre_departamento, departamento.ubicacion, departamento.directiva, departamento.funcion, departamento.numero_de_empleados, empleado.nombres, empleado.apellidos, users.loginUsers FROM departamento, empleado, users WHERE (departamento.id_empl =empleado.id_empl =empleado.id_empl) AND (users.idUsers='".$_SESSION["iduser"]."')";
