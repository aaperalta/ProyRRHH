...
<?php include("includes/cabecera.php"); ?>
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
    ...
    <h1>NOMINAS</h1>
<a href="ListadoNominas.php" class="btn btn-success"  > Listar Nominas </a> 
<a href="ListadoBeneficio.php" class="btn btn-success"  > Listar Beneficio </a> 
<a href="ListadoDescuento.php" class="btn btn-success"  > Listar Descuento </a>  
<br />
<br />
<br />
<br />
