...
$query_Recordset1 = "SELECT justificacion.dia_falta, justificacion.dia_justifico, justificacion.motivo, justificacion.documento, empleado.nombres, empleado.apellidos, users.loginUsers FROM justificacion, empleado, users WHERE (justificacion.id_empl =empleado.id_empl =empleado.id_empl) AND (users.idUsers='".$_SESSION["iduser"]."')";
...
<?php include("includes/cabecera.php"); ?>
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
    ...
    <h4><strong>FALTAS JUSTIFICADAS</strong></h4>
    <div class="container-fluid">
	<div class="table-responsive">
			<div align="center" class="form-group" class="containers" >
				<button  class="btn btn-primary">Nueva Justificaci&oacuten</button>
			</div>
    <table class="table"  table-striped table-bordered border="1" table-hover>
      <tr class="success">
        <td>Dia que Falt&oacute</td>
        <td>Dia que Justific&oacute</td>
        <td>Motivo</td>
        <td>Documento justificativo</td>
      ...
      <?php do { ?>
        <tr>
          <td><?php echo $row_Recordset1['dia_falta']; ?></td>
          <td><?php echo $row_Recordset1['dia_justifico']; ?></td>
          <td><?php echo $row_Recordset1['motivo']; ?></td>
          <?php $documento_1 = $row_Recordset1['documento'];?>
          <td><img width="60%" src=" data:image/jpg; base64 , <?php echo base64_encode ($documento_1);?>" /> </td>
