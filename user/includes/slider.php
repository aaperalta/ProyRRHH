	    ...
	    <div id="fragment-1" class="ui-tabs-panel" style="">
			<img src="imagenes/slider/image111.jpg" alt="" />
			 <div class="info" >
				...
				<p>Este Web esta diseñada para optimizar todos los tramites de los empleados.</p>
			 </div>
	    </div>
	    ...
	    <div id="fragment-3" class="ui-tabs-panel ui-tabs-hide" style="">
			<img src="imagenes/slider/image33.jpg" alt="" />
			 <div class="info" >
				...
				<p>Mas inromacion de seguimiento de tramites, encontraran en la seccion de tramites.</p>
	         </div>
	    </div>
