...
$query_Recordset1 = "SELECT descuento.tipo_descuento, descuento.valor_descuento, nomina.sueldo_nominal, empleado.cedula, users.loginUsers FROM descuento, nomina, empleado, users WHERE (descuento.id_nom = nomina.id_nom =nomina.id_empl =empleado.id_empl) AND (users.idUsers= '".$_SESSION["iduser"]."')";
...
<?php include("includes/cabecera.php"); ?>
  ...
  <h4><strong>LISTADO DE DESCUENTOS</strong></h4>
