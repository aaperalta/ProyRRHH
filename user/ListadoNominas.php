...
$query_Recordset1 = "SELECT nomina.sueldo_nominal, nomina.total_horas_extra, nomina.beneficio_horas_extra, nomina.comisiones, nomina.fecha_ingreso, empleado.nombres, empleado.apellidos, users.loginUsers FROM nomina, empleado, users WHERE (nomina.id_empl = empleado.id_empl  = empleado.id_empl  =users.id_empl) AND (users.idUsers = '".$_SESSION["iduser"]."')";
...
<?php include("includes/cabecera.php"); ?>
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
      ...
      <h4><strong>LISTADO DE NOMINAS</strong></h4>
   ...
   <div class="container-fluid">
    ...
    <td>Horas Extra</td>
    <td>Beneficio de Horas Extra</td>
    <td>Comisiones</td>
