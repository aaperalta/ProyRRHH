  ...
  <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="id_empl" value="<?php echo $row_Recordset1['id_empl']; ?>" size="32" /></td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Vestimenta:</td>
          <td><input type="text" name="vestimenta" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Alimento:</td>
          <td><input type="text" name="alimento" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Vivienda:</td>
          <td><input type="text" name="vivienda" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Salud:</td>
          <td><input type="text" name="salud" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Educacion:</td>
          <td><input type="text" name="educacion" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Ejercicio_formal:</td>
          <td><input type="text" name="ejercicio_formal" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
