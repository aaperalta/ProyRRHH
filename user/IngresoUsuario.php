...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO usuario (id_empl, nombre, rol, estado, clave) VALUES (%s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "ListadoUsuarios.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="id_empl" value="<?php echo $row_Recordset1['id_empl']; ?>" size="32" /></td>
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="rol" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
