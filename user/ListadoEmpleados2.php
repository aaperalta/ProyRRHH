...
<?php include("includes/cabecera.php"); ?>
  ...
  <tr>
    <td><a href="IngresoEmpleado.php">Ingresar Nuevo Empleado</a></td>
  </tr>
</table>
    ...
    <table border="1">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><a href="ModificarEmpleados.php?cedula=<?php echo $row_Recordset1['cedula']; ?>">Modificar</a></td>
          <td><a href="EliminarEmpleado.php?id_empl=<?php echo $row_Recordset1['id_empl']; ?>">Eliminar</a></td>
          <td><a href="IngresoUsuario.php?id_empl=<?php echo $row_Recordset1['id_empl']; ?>">Asignar Usuario</a></td>
          <td><a href="IngresoNomina.php?id_empl=<?php echo $row_Recordset1['id_empl']; ?>">Ingresar Nomina</a></td>
        </tr>
