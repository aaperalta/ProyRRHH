  ...
  <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="id_empl" value="<?php echo $row_Recordset1['id_empl']; ?>" size="32" /></td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Numero_de_cargas:</td>
          <td><input type="text" name="numero_de_cargas" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Tipo_causante_de_carga:</td>
          <td><input type="text" name="tipo_causante_de_carga" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Beneficio_de_carga:</td>
          <td><input type="text" name="beneficio_de_carga" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
