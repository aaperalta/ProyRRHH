...
<div class="container">
  <table >
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Tipo_beneficio:</td>
      <td><input type="text" name="tipo_beneficio" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><div align="center"> <button class="btn btn-primary " type="submit" name="submit" value="Insert record" >Enviar</button> </div></td>
    </tr>
	</div>
  </table>
  </div>
