...
$query_Recordset1 = "SELECT referencias.nombresr, referencias.apellidosr, referencias.edad, referencias.tiempo_de_relacion, referencias.domicilio, referencias.telefono, referencias.celular, referencias.correo, empleado.nombres, empleado.apellidos, users.loginUsers FROM referencias, empleado, users WHERE (referencias.id_empl =empleado.id_empl =empleado.id_empl =users.id_empl) AND (users.idUsers='".$_SESSION["iduser"]."')";
