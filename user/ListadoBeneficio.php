...
$query_Recordset1 = "SELECT beneficio.tipo_beneficio, beneficio.descripcion, beneficio.monto, nomina.sueldo_nominal, empleado.cedula, users.loginUsers FROM beneficio, nomina, empleado, users WHERE (beneficio.id_nom = nomina.id_nom = nomina.id_empl = empleado.id_empl) AND (users.idUsers = '".$_SESSION["iduser"]."')";
...
<?php include("includes/cabecera.php"); ?>
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
    ...
    <h4>
    <p><strong>LISTADO DE NOMINAS</strong>
    </h4>
