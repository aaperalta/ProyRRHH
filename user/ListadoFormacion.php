...
$query_Recordset1 = "SELECT formacion.propietario, formacion.instituto, formacion.nivel, formacion.especializacion, formacion.area, formacion.estado, formacion.duracion, formacion.fecha_de_inicio, formacion.fecha_de_incorporacion, empleado.nombres, empleado.apellidos, users.loginUsers FROM formacion, empleado, users WHERE (empleado.id_empl =formacion.id_empl =empleado.id_empl =users.id_empl) AND (users.idUsers='".$_SESSION["iduser"]."')";
