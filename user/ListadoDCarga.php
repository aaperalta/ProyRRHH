...
$query_Recordset1 = "SELECT datos_carga.sexo, datos_carga.nombresc, datos_carga.apellidosc, datos_carga.fecha_de_nacimieto, datos_carga.edad, datos_carga.tipo_de_relacion, datos_carga.estado_civil, datos_carga.discapasidad, carga_familiar.tipo_causante_de_carga, empleado.nombres, empleado.apellidos, users.idprofile FROM datos_carga, carga_familiar, empleado, users WHERE (datos_carga.id_carga = carga_familiar.id_carga) AND (carga_familiar.id_empl = empleado.id_empl)  AND (users.id_empl =empleado.id_empl) AND (users.idUsers ='".$_SESSION["iduser"]."')";
...
<?php include("includes/cabecera.php"); ?>
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
    ...
    <h4><strong>DATOS DE CARGA LABORAL</strong></h4>
