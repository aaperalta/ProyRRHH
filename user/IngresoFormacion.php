...
<h1>INGRESAR FORMULARIO</h1>
  ...
  <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Instituto:</td>
        <td><input type="text" name="instituto" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Especializacion:</td>
        <td><input type="text" name="especializacion" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Duracion:</td>
        <td><input type="text" name="duracion" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Fecha_de_inicio:</td>
        <td><input type="text" name="fecha_de_inicio" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Fecha_de_incorporacion:</td>
        <td><input type="text" name="fecha_de_incorporacion" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
