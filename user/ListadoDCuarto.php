...
$query_Recordset1 = "SELECT decimo_cuarto.inicio_laboral, decimo_cuarto.maximo_pago, decimo_cuarto.sueldo, decimo_cuarto.d_cuarto, empleado.nombres, empleado.apellidos, users.loginUsers FROM decimo_cuarto, empleado, users WHERE (decimo_cuarto.id_empl =empleado.id_empl =empleado.id_empl) AND (users.idUsers='".$_SESSION["iduser"]."')";
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
    ...
    <table class="table"  table-striped table-bordered border="1" table-hover>
      <tr class="success">
        ...
        <td>Sueldo</td>
        <td>Valor del decimo cuarto sueldo</td>
      ...
      <?php do { ?>
        <tr>
          ...
          <td>$<?php echo $row_Recordset1['d_cuarto']; ?></td>
