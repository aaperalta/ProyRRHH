  ...
  <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="id_empl" value="<?php echo $row_Recordset1['id_empl']; ?>" size="32" /></td>
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Nombre_departamento:</td>
          <td><input type="text" name="nombre_departamento" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Directiva:</td>
          <td><input type="text" name="directiva" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Funcion:</td>
          <td><input type="text" name="funcion" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Numero_de_empleados:</td>
          <td><input type="text" name="numero_de_empleados" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
