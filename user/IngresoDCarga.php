...
<?php include("includes/cabecera.php"); ?>
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Id_carga:</td>
          <td><input type="text" name="id_carga" value="<?php echo $row_Recordset1['id_carga']; ?>" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Cedula:</td>
          <td><input type="text" name="cedulac" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="nombresc" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Apellidos:</td>
          <td><input type="text" name="apellidosc" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Fecha_de_nacimieto:</td>
          <td><input type="text" name="fecha_de_nacimieto" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Tipo_de_sangre:</td>
          <td><input type="text" name="tipo_de_sangre" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Tipo_de_relacion:</td>
          <td><input type="text" name="tipo_de_relacion" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap="nowrap" align="right">Discapasidad:</td>
          <td><input type="text" name="discapasidad" value="" size="32" /></td>
        </tr>
        <tr valign="baseline">
