...
<?php include("includes/cabecera.php"); ?>
  ...
  <div class="sidebar1"><!-- InstanceBeginEditable name="Contenido_izq" -->
    ...
    <h1>BENEFICIO SOCIAL</h1>
	
<a href="ListadoDTercer.php" class="btn btn-success"  > Decimos Tercero </a>
<a href="ListadoDCuarto.php" class="btn btn-success"  > Decimos Cuarto </a>
<a href="ListadoUtilidades.php" class="btn btn-success"  > Utilidades </a>
