...
$query_Recordset1 = "SELECT carga_familiar.numero_de_cargas, carga_familiar.tipo_causante_de_carga, carga_familiar.beneficio_de_carga, empleado.nombres, empleado.apellidos, users.loginUsers FROM carga_familiar, empleado, users WHERE (carga_familiar.id_empl =empleado.id_empl =empleado.id_empl =users.id_empl) AND (users.idUsers='".$_SESSION["iduser"]."')";
